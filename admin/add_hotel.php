...
<div class="content">
  <div class="container">
    ...
    <form action="save_add_hotel.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group ">
        <label for="exampleFormControlInput1">Hote Description</label>
        <input name="hoteldescription" type="text" class="form-control" id="exampleFormControlInput1" require>
      </div>
      <div class="form-group ">
        <label for="exampleFormControlInput1">Hote Location</label>
        <input name="hotellocation" type="text" class="form-control" id="exampleFormControlInput1" require>
      </div>
