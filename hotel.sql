...
--
-- Host: localhost
-- Generation Time: Feb 13, 2020 at 10:15 AM
...
(13, 'Trident Nariman Point ', 'decription 2', 'Mumbai', 200, 4, 0, 'trident.jpg'),
(14, 'Radisson Mumbai ', 'description3', 'mumbai', 100, 5, 0, 'radisson.jpg'),
...
INSERT INTO `packages` (`package_id`, `package_name`, `package_price`, `package_details`, `package_location`, `days`, `package_image`) VALUES
...
(44, 'Holiday in Manali & Shimla', 10000, 'Sightseeing in scenic Shimla | Visit to Solang Valley | Comfortable private transfers from and to Delhi (with pit stops for Maggi!) | Value Pack included in the package', 'Manali,Shimla', '5N/4D', 'manali.jpeg'),
(45, 'Mini Kerala - Value Added', 7000, 'Visit backwaters and tea gardens | See Eravikulam National Park | Car value pack - Snack box on arrival & extra 2 hours at disposal, once in each city', 'kerla', '3N/2D', 'kerla.jpeg'),
...
(47, 'Complete Rajasthan Holiday (9 days)', 25000, '2N Jaipur . 1N Bikaner . 2N Jaisalmer . 1N Jodhpur . 2N Udaipur', 'Rajasthan', '10N/9D', 'rajasthan.jpg'),
(48, 'Ooty & Mysore with Bangalore - Value Added', 12000, '1N Bangalore . 1N Mysore . 2N Ooty,\r\n\r\nSightseeing in scenic Mysore & Ooty | Visit to Co0noor | Comfortable private transfers from and to Bangalore!!', 'karnatka', '5N/4D', 'Mysore.png'),
(49, 'Best of Kashmir', 15000, '2N Srinagar . 2N Gulmarg', 'kashmir', '4N/4D', 'kashmir.jpg');
